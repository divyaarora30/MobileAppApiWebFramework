...
public class ExcelUtils {
    ...
    private static String sheetPath = PropertiesFileManager.getProperty("test.data.path") + PropertiesFileManager.getProperty("excel.name");
    private static String sheetName = PropertiesFileManager.getProperty("sheet.name");
